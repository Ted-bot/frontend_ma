...
const LocationInput = ({errorMessage: error, stateId, cityId, onChangeStateId, onChangeState, onChangeCityId, onChangeCity, stateError, cityError}) => { // id,
