export default function FeatureCard() {
    ...
    return (
        <>
                <div className="rounded-xl bg-white text-center max-w-sm group relative cursor-pointerpx-6 pt-10 pb-8 shadow-xl ring-1 mb-8 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mt-0 sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10 md:mx-5 md:mb-0 md:mt-8">
                    <div
