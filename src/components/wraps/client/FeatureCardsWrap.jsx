export default function FeatureCardsWrap({children}) {
        ...
        <>
            <section className="flex-col pb-8">
                <section className="w-full text-center pt-2 pb-[10rem] sm:pt-4 sm:pb-[6rem] md:pt-2 md:pb-[6rem] lg:pb-[8rem] xl:pt-2 2xl:pb-[10rem]">
                    <h2 className="translate-y-16 text-5xl sm:translate-y-12 lg:translate-y-12 xl:translate-y-16 2xl:translate-y-24">Valueable</h2>
                </section>
